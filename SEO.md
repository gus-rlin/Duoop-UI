...
- The sitemap contains **56 URLs**: home, catalog, installation, examples index, one outdoor adventure landing-page example, 7 categories, and 44 components. Source-only SettingsPage.jsx has no public example route. Exclude searches, alternate tabs, preview domains and invented modification dates.
