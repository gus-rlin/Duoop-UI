...
import { AchievementEmblem } from '../Achievement/Achievement';
...
export function ExperiencePreview({ kind }) {
  ...
  return <span className="mini-achievement"><AchievementEmblem /><span><small>FIRST MILESTONE</small><strong>First steps</strong><em><ExperienceIcon name="success" /> Unlocked</em></span></span>;
}
