...
const collection = [{ ...firstSteps, state:'claimed', progress:3, unlockedAt:'2026-09-07', tier:'Bronze' }, { ...firstSteps, id:'regular', title:'A little, every day', description:'Keep a seven-day writing streak.', icon:'flame', unit:'consecutive days', progress:4, target:7, tier:'Silver', reward:'New journal cover' }, { ...firstSteps, id:'secret', title:'The hidden chapter', state:'locked', visibility:'hidden', progress:0, tier:'Gold' }];
