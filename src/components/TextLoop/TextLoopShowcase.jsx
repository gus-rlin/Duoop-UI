...
export function TextLoopShowcase() {
  return <CatalogShowcase entry={textLoopEntry} number="26" section="ANIMATIONS" examples={textLoopExamples} Demo={TextLoopDemo} playground={<TextLoopPlayground />}
    ...
    usage="Use TextLoop for short editorial phrases and decorative banners. Inspired by the supplied TextLoop, with Duoop-UI’s neutral surfaces, dark contours and short shadows. Supply an adjacent pause control for continuous motion. Keep essential instructions in ordinary text as well: curved typography is a visual accent. The component uses the existing GSAP dependency and inherits the shared feedback palette."
    ...
    api={[
      ...
      ['ribbon / ribbonWidth / ribbonColor', 'Show the outlined ribbon (default true), width in SVG units (86), and its face color.'],
      ['fontSize / fontWeight / letterSpacing', 'SVG text metrics: 46, 800 and 2 by default. Font loading triggers remeasurement.'],
