...
try {
 ...
 for (const width of [1440,390]) {
  ...
  await page.goto('http://127.0.0.1:5176/?page=examples&example=landing',{waitUntil:'domcontentloaded'});
  ...
  const offset=()=>loop.locator('textPath').first().getAttribute('startOffset');
